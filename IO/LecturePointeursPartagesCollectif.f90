...
! mode collectif, et en extrait 121 valeurs
!
...
program lecture_pointeurs_partages_collectif
    ...
    character(len=14), parameter :: base_nom_fichier_cible = "fichier_ptpaco"
    ...
    ! Lecture via des pointeurs partagés, en mode collectif
    call MPI_FILE_READ_ORDERED(file_descriptor, &
                               valeurs_lues(1), &
